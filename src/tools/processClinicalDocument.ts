          ...
          for (const doc of documents) {
            ...
            if (!attachment) {
              ...
              results.push({
                ...
                type: docType,
                date: docDate,
                contentType: narrativeText ? "text/html" : "unknown",
                extractedText: narrativeText || "No content or narrative found in this DocumentReference",
                method: "narrative",
              });
              continue;
            }
            ...
            if (mimeBase.startsWith("text/")) {
              ...
              try {
                ...
                results.push({
                  ...
                  date: docDate,
                  contentType,
                  extractedText: `OCR failed: ${ocrErr.message}. Narrative: ${narrativeText || "none"}`,
                  method: "narrative",
                });
              }
