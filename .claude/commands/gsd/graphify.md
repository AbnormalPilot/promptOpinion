...
Knowledge graph is disabled. To activate:
  ...
  node /Users/himanshu/Desktop/promptOpinion/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/himanshu/Desktop/promptOpinion/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/himanshu/Desktop/promptOpinion/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "/Users/himanshu/Desktop/promptOpinion/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: /Users/himanshu/Desktop/promptOpinion/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"/Users/himanshu/Desktop/promptOpinion/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
