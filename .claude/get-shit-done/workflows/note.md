...
- **Global scope**: `/Users/himanshu/Desktop/promptOpinion/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/himanshu/Desktop/promptOpinion/.claude/notes/`)
...
2. Glob `/Users/himanshu/Desktop/promptOpinion/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/himanshu/Desktop/promptOpinion/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/himanshu/Desktop/promptOpinion/.claude/notes/` — works in any directory
