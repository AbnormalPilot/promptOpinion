...
```bash
AUDITOR_MODEL=$(node "/Users/himanshu/Desktop/promptOpinion/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read /Users/himanshu/Desktop/promptOpinion/.claude/agents/gsd-eval-auditor.md for instructions.
