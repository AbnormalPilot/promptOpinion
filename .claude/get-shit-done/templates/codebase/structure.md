...
- Usage: Reference from command with `@/Users/himanshu/Desktop/promptOpinion/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/himanshu/Desktop/promptOpinion/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/himanshu/Desktop/promptOpinion/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
